...
int ParseSCTE35FromByteArray(
    ...
    *splice_info_section_struct_list = (splice_info_section_struct_list_t *) malloc(
            sizeof(splice_info_section_struct_list_t));
    // set working pointer
    ...
    while (remaining_bits > 0) {
        ...
        switch (section->splice_command_type) {
            case 4: { // splice_schedule();
                section->splice_command_ptr = (splice_schedule_t *) calloc(sizeof(splice_schedule_t), sizeof(char));
//                section->splice_command_printer = (void (*)(void *)) splice_schedule_printer;
                // set working pointer
                ...
                for (int k = 0; k < splice_schedule->splice_count; k++) {
                    ...
                    if (splice_schedule->splice_schedule_event_t[k].splice_event_cancel_indicator == 0) {
                        splice_schedule->splice_schedule_event_t[k].out_of_network_indicator = ReadBitsFromArray(
                                filebuffer_bits, 1,
                                &filebuffer_bits_index);
                        splice_schedule->splice_schedule_event_t[k].program_splice_flag = ReadBitsFromArray(
                                filebuffer_bits,
                                1,
                                &filebuffer_bits_index);
                        splice_schedule->splice_schedule_event_t[k].duration_flag = ReadBitsFromArray(filebuffer_bits,
                                                                                                      1,
                                                                                                      &filebuffer_bits_index);
                        ...
                        if (splice_schedule->splice_schedule_event_t[k].program_splice_flag == 1) {
                            ...
                            splice_schedule->splice_schedule_event_t[k].component_count = ReadBitsFromArray(
                                    filebuffer_bits,
                                    8,
                                    &filebuffer_bits_index);
                        ...
                        splice_schedule->splice_schedule_event_t[k].unique_program_id = ReadBitsFromArray(
                                filebuffer_bits,
                                16,
                                &filebuffer_bits_index);
                        splice_schedule->splice_schedule_event_t[k].avail_num = ReadBitsFromArray(filebuffer_bits, 8,
                                                                                                  &filebuffer_bits_index);
                        splice_schedule->splice_schedule_event_t[k].avails_expected = ReadBitsFromArray(filebuffer_bits,
                                                                                                        8,
                                                                                                        &filebuffer_bits_index);
            ...
            case 5: // splice_insert();
            {
                ...
                splice_insert->splice_event_cancel_indicator = ReadBitsFromArray(filebuffer_bits, 1,
                                                                                 &filebuffer_bits_index);
                ...
                if (splice_insert->splice_event_cancel_indicator == 0) {
                    splice_insert->out_of_network_indicator = ReadBitsFromArray(filebuffer_bits, 1,
                                                                                &filebuffer_bits_index);
                    ...
                    splice_insert->splice_immediate_flag = ReadBitsFromArray(filebuffer_bits, 1,
                                                                             &filebuffer_bits_index);
                    splice_insert->splice_event_reserved = ReadBitsFromArray(filebuffer_bits, 4,
                                                                             &filebuffer_bits_index);
                    if (splice_insert->program_splice_flag == 1 &&
                        splice_insert->splice_immediate_flag == 0) {
                        splice_insert->splice_time.time_specified_flag = ReadBitsFromArray(filebuffer_bits, 1,
                                                                                           &filebuffer_bits_index);
                    ...
                    if (splice_insert->program_splice_flag == 0) {
                        ...
                        for (int i = 0; i < splice_insert->component_count; i++) {
                            splice_insert->component_t[i].component_tag = ReadBitsFromArray(filebuffer_bits, 8,
                                                                                            &filebuffer_bits_index);
                            if (splice_insert->splice_immediate_flag == 0) {
                                splice_insert->component_t[i].splice_time.time_specified_flag = ReadBitsFromArray(
                                        filebuffer_bits, 1, &filebuffer_bits_index);
                                if (splice_insert->component_t[i].splice_time.time_specified_flag) {
                                    splice_insert->component_t[i].splice_time.time_specified_flag_reserved = ReadBitsFromArray(
                                            filebuffer_bits, 6, &filebuffer_bits_index);
                                    splice_insert->component_t[i].splice_time.pts_time = ReadBitsFromArray(
                                            filebuffer_bits, 33, &filebuffer_bits_index);
                                } else {
                                    splice_insert->component_t[i].splice_time.reserved = ReadBitsFromArray(
                    ...
                    if (splice_insert->duration_flag == 1) {
                        splice_insert->break_duration.auto_return = ReadBitsFromArray(filebuffer_bits, 1,
                                                                                      &filebuffer_bits_index);
                        splice_insert->break_duration.reserved = ReadBitsFromArray(filebuffer_bits, 6,
                                                                                   &filebuffer_bits_index);
                        splice_insert->break_duration.duration = ReadBitsFromArray(filebuffer_bits, 33,
                                                                                   &filebuffer_bits_index);
                    } // if splice_insert->duration_flag == 1
            ...
            case 6: // time_signal();
            {
                ...
                if (splice_time->time_specified_flag) {
                    splice_time->time_specified_flag_reserved = ReadBitsFromArray(filebuffer_bits, 6,
                                                                                  &filebuffer_bits_index);
        ...
        section->segmentation_descriptor = (segmentation_descriptor_t *) malloc(
                section->descriptor_loop_length * sizeof(segmentation_descriptor_t));
        ...
        while (((filebuffer_bits_index - descriptor_loop_start_bits) / 8) < section->descriptor_loop_length) {
            ...
            section->segmentation_descriptor[section->segmentation_descriptor_count].segmentation_event_id = ReadBitsFromArray(
                    filebuffer_bits, 32, &filebuffer_bits_index);
            section->segmentation_descriptor[section->segmentation_descriptor_count].segmentation_event_cancel_indicator = ReadBitsFromArray(
                    filebuffer_bits, 1, &filebuffer_bits_index);
            section->segmentation_descriptor[section->segmentation_descriptor_count].reserved = ReadBitsFromArray(
                    filebuffer_bits, 7, &filebuffer_bits_index);
            if (section->segmentation_descriptor[section->segmentation_descriptor_count].segmentation_event_cancel_indicator ==
                0) {
                section->segmentation_descriptor[section->segmentation_descriptor_count].program_segmentation_flag = ReadBitsFromArray(
                        filebuffer_bits, 1, &filebuffer_bits_index);
                section->segmentation_descriptor[section->segmentation_descriptor_count].segmentation_duration_flag = ReadBitsFromArray(
                        filebuffer_bits, 1, &filebuffer_bits_index);
                section->segmentation_descriptor[section->segmentation_descriptor_count].delivery_not_restricted_flag = ReadBitsFromArray(
                        filebuffer_bits, 1, &filebuffer_bits_index);
                if (section->segmentation_descriptor[section->segmentation_descriptor_count].delivery_not_restricted_flag ==
                    0) {
                    section->segmentation_descriptor[section->segmentation_descriptor_count].web_delivery_allowed_flag = ReadBitsFromArray(
                            filebuffer_bits, 1, &filebuffer_bits_index);
                    section->segmentation_descriptor[section->segmentation_descriptor_count].no_regional_blackout_flag = ReadBitsFromArray(
                            filebuffer_bits, 1, &filebuffer_bits_index);
                    section->segmentation_descriptor[section->segmentation_descriptor_count].archive_allowed_flag = ReadBitsFromArray(
                            filebuffer_bits, 1, &filebuffer_bits_index);
                    section->segmentation_descriptor[section->segmentation_descriptor_count].device_restrictions = ReadBitsFromArray(
                            filebuffer_bits, 2, &filebuffer_bits_index);
                } else {
                    section->segmentation_descriptor[section->segmentation_descriptor_count].reserved_flags = ReadBitsFromArray(
                            filebuffer_bits, 5, &filebuffer_bits_index);
                }

                if (section->segmentation_descriptor[section->segmentation_descriptor_count].program_segmentation_flag ==
                    0) {
                    section->segmentation_descriptor[section->segmentation_descriptor_count].component_count = ReadBitsFromArray(
                            filebuffer_bits, 8, &filebuffer_bits_index);
                    for (int i = 0; i <
                                    section->segmentation_descriptor[section->segmentation_descriptor_count].component_count; i++) {
                        section->segmentation_descriptor[section->segmentation_descriptor_count].component_tags[section->segmentation_descriptor_count].component_tag = ReadBitsFromArray(
                                filebuffer_bits, 8, &filebuffer_bits_index);
                        section->segmentation_descriptor[section->segmentation_descriptor_count].component_tags[section->segmentation_descriptor_count].reserved = ReadBitsFromArray(
                                filebuffer_bits, 7, &filebuffer_bits_index);
                        section->segmentation_descriptor[section->segmentation_descriptor_count].component_tags[section->segmentation_descriptor_count].pts_ofset = ReadBitsFromArray(
                                filebuffer_bits, 33, &filebuffer_bits_index);
                    }
                }
                if (section->segmentation_descriptor[section->segmentation_descriptor_count].segmentation_duration_flag ==
                    1) {
                    section->segmentation_descriptor[section->segmentation_descriptor_count].segmentation_duration = ReadBitsFromArray(
                            filebuffer_bits, 40, &filebuffer_bits_index);
                }
                section->segmentation_descriptor[section->segmentation_descriptor_count].segmentation_upid_type = ReadBitsFromArray(
                        filebuffer_bits, 8, &filebuffer_bits_index);
                section->segmentation_descriptor[section->segmentation_descriptor_count].segmentation_upid_length = ReadBitsFromArray(
                        filebuffer_bits, 8, &filebuffer_bits_index);
                for (int ii = 0; ii <
                                 section->segmentation_descriptor[section->segmentation_descriptor_count].segmentation_upid_length; ii++) {
                    section->segmentation_descriptor[section->segmentation_descriptor_count].segmentation_upid_data[ii] = ReadBitsFromArray(
                            filebuffer_bits, 8, &filebuffer_bits_index);
                }
                /*
                ...
                */
                section->segmentation_descriptor[section->segmentation_descriptor_count].segmentation_type_id = ReadBitsFromArray(
                        filebuffer_bits, 8, &filebuffer_bits_index);
                section->segmentation_descriptor[section->segmentation_descriptor_count].segment_num = ReadBitsFromArray(
                        filebuffer_bits, 8, &filebuffer_bits_index);
                section->segmentation_descriptor[section->segmentation_descriptor_count].segments_expected = ReadBitsFromArray(
                        filebuffer_bits, 8, &filebuffer_bits_index);
                if (section->segmentation_descriptor[section->segmentation_descriptor_count].segmentation_type_id ==
                    0x34 ||
                    section->segmentation_descriptor[section->segmentation_descriptor_count].segmentation_type_id ==
                    0x36) {
                    section->segmentation_descriptor[section->segmentation_descriptor_count].sub_segment_num = ReadBitsFromArray(
                            filebuffer_bits, 8, &filebuffer_bits_index);
                    section->segmentation_descriptor[section->segmentation_descriptor_count].sub_segments_expected = ReadBitsFromArray(
                            filebuffer_bits, 8, &filebuffer_bits_index);
                }
